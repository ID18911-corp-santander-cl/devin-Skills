...
# MAGIC %md
# MAGIC ## 6. Escritura en tabla de paso pro_app.essenneg.Banco_DCV_paso
...
# MAGIC %md
# MAGIC ## 7. Escritura en tabla de paso pro_app.essenneg.Banco_Rutero_paso
...
spark.sql(f"""
    ...
    WITH max_acciones AS (
        ...
        FROM pro_app.essenneg.Banco_DCV_paso
    )
    SELECT
    ...
    FROM pro_app.essenneg.Banco_DCV_paso DCV
    ...
    LEFT JOIN (
        ...
        FROM pro_app.essenneg.Banco_Rutero_paso
