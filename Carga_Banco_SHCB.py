...
# MAGIC %md
# MAGIC # Carga de Banco DCV y Rutero CSV a pro_business.essenexp.Banco_SHCB_Detalle y Banco_SHCB
# MAGIC
# MAGIC Este notebook:
...
# MAGIC 3. Elimina registros existentes en `pro_business.essenexp.Banco_SHCB_Detalle` para la fecha de proceso
# MAGIC 4. Inserta los datos cruzados desde las tablas de paso a `pro_business.essenexp.Banco_SHCB_Detalle`
# MAGIC 5. Genera la tabla resumen `pro_business.essenexp.Banco_SHCB` con 101 registros a partir de `Banco_SHCB_Detalle`
# MAGIC
...
# MAGIC %md
# MAGIC ## 9. DELETE por data_date_part e INSERT en pro_business.essenexp.Banco_SHCB_Detalle

# COMMAND ----------

dest_table_detalle = "pro_business.essenexp.Banco_SHCB_Detalle"

# DELETE registros existentes para la fecha de proceso
spark.sql(f"""
    DELETE FROM pro_business.essenexp.Banco_SHCB_Detalle
...
spark.sql(f"""
    INSERT INTO pro_business.essenexp.Banco_SHCB_Detalle
...
# MAGIC %md
# MAGIC ## 10. Verificacion de la tabla destino (Banco_SHCB_Detalle)
...
# MAGIC %md
# MAGIC ## 10a. DELETE por data_date_part e INSERT en pro_business.essenexp.Banco_SHCB (resumen 101 registros)
...
# MAGIC %md
# MAGIC ## 10b. Verificacion de la tabla resumen (Banco_SHCB)
        ...
        SELECT  intergrupo AS shcode,
            ...
            FROM (
                SELECT  intergrupo,
                        ...
                        sum(acciones) AS pp
                    FROM (
                        SELECT  orden, acciones, accionista, depositos, more_detail,
                                intergrupo, agrupacion_de_accionistas, transaction_currency,
                                sum(acciones) OVER() AS total_acciones,
                                '000000000000' AS ISIN
                            FROM pro_business.essenexp.Banco_SHCB
                            WHERE data_date_part = '{data_date_part}'
                    ) A
                    GROUP BY intergrupo,
                        agrupacion_de_accionistas,
